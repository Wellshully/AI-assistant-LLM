...
client = genai.Client(http_options=HttpOptions(api_version="v1beta"), api_key="AIzaSyDEwTDG5ul6RGCoVIamkn7FtCfm4XFOAX8")
...
if __name__ == "__main__":
    mem = load_memory()
    print("🎤 語音模式已啟動：說 “hey turn on/off light”, “hey shutdown my pc” 或 “hey listen”")
    while True:
        hotword_listener()
        time.sleep(0.5)
        u = record_speech(8)
